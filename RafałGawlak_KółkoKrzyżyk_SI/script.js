...
function clickedCell(cell) {
	var button = document.getElementById('button-restart')
...
function restartBnt(button) {
	if (button.value == 'Zaczyna komputer') {
		aiTurn()
		button.disabled = true
